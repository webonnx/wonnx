...
backend_test.include(f"test_Conv2d_groups[a-z,_]*")
backend_test.include(f"test_Conv2d_no_bias[a-z,_]*")
backend_test.include(f"test_Conv2d_padding[a-z,_]*")
backend_test.include(f"test_Conv2d_strided[a-z,_]*")
